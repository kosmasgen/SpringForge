...
public class ColumnDefinition extends PostgreSQLBaseListener {
    ...
    /**
     * Extracts numeric precision and scale from a SQL type declaration.
     *
     * @param typeText SQL type definition text
     */
    ...
    /**
     * Parses SQL column type modifiers such as length, precision, and scale.
     *
     * @param ctx column type modifier parser context
     */
    @Override
    ...
    /**
     * Parses IDENTITY column configuration metadata.
     *
     * @param ctx identity column parser context
     */
    @Override
    ...
    /**
     * Parses GENERATED column metadata and identity configuration.
     *
     * @param ctx generated column parser context
     */
    @Override
    public void enterGeneratedColumn(PostgreSQLParser.GeneratedColumnContext ctx) {
        ...
        if (normalizedGeneratedColumnText.contains("GENERATED")
            ...
            this.generatedAs = generatedColumnText
